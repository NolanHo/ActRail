...
describe("SessionsPane", () => {
  ...
  it("renders transport health on session cards", () => {
    ...
    expect(dots[3]?.classList.contains("unhealthy")).toBe(true);
    expect(dots[3]?.getAttribute("title")).toBe("restart session required");
    expect(dots[4]?.classList.contains("healthy")).toBe(true);
