...
type Service interface {
	...
	CodexSessionFiles(context.Context, CodexSessionFilesRequest) (CodexSessionFilesResponse, error)
	CodexSessionFile(context.Context, CodexSessionFileRequest) (CodexSessionFileResponse, error)
	RenameCodexSessionFile(context.Context, RenameCodexSessionFileRequest) (RenameCodexSessionFileResponse, error)
